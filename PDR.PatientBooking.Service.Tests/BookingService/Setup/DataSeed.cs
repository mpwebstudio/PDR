    ...
    public static class DataSeed
    {
        public static List<Order> SeedOrders(DateTime time)
        {
            return new List<Order>
            {
                ...
                new Order { Id = Guid.Parse("720ac38e-84ac-4502-9792-64d203463f14"), PatientId = 1, DoctorId = 1, StartTime = time.AddMinutes(15), EndTime = time.AddMinutes(30), SurgeryType = 1, IsCancelled = true},
                ...
                new Order { Id = Guid.Parse("63e67002-4fa2-45d8-b18d-4dfcd70045fe"), PatientId = 2, DoctorId = 1, StartTime = time.AddMinutes(30), EndTime = time.AddMinutes(45), SurgeryType = 0, IsCancelled = true},
                new Order { Id = Guid.Parse("30d05064-754d-4ad6-832f-94a10d6ba8b8"), PatientId = 3, DoctorId = 1, StartTime = time.AddMinutes(45), EndTime = time.AddMinutes(60), SurgeryType = 0, IsCancelled = true},
                ...
                new Order { Id = Guid.Parse("fa8c163c-4167-4a68-91eb-2381affae9e7"), PatientId = 4, DoctorId = 1, StartTime = time.AddMinutes(130), EndTime = time.AddMinutes(145), SurgeryType = 0, IsCancelled = true},
            };
        }
    }
}